...
LEDGER_FILE = os.path.join(CURRENT_DIR, "manitoba_lobbyists_historical.csv")

def clean_and_verify_ledger():
    print("====================================================")
    print("STARTING MANITOBA LEDGER DEDUPLICATION & CLEANING")
    print("====================================================\n")
    
    if not os.path.exists(LEDGER_FILE):
        print(f"[FATAL ERROR] Manitoba ledger not found at: {LEDGER_FILE}")
        return
    ...
    try:
        ...
        # Deduplicate on REGISTRATION NUMBER (keep first seen - which is newest date due to sort)
        seen_regs = set()
        cleaned_rows = []
        ...
        print("\n====================================================")
        print("MAINTENANCE SEQUENCE COMPLETE: MANITOBA LEDGER SECURE")
        print("====================================================")
