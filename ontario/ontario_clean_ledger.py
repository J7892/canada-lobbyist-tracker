"""
ontario_clean_ledger.py
Standalone automated maintenance script for the Ontario Lobbyist Registry Ledger.
...
LEDGER_FILE = os.path.join(CURRENT_DIR, "ontario_lobbyists_historical.csv")
